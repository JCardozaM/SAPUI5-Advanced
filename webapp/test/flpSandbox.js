		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employees ",
									"targetURL": "#esjemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"esjemployees-display": {
								"semanticObject": "esjemployees",
								"action": "display",
								"description": "A Fiori application.Employees ",
								"title": "Employees ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=esj.employees",
									"url": sap.ui.require.toUrl("esj/employees")
								}
							}
						}
					}
